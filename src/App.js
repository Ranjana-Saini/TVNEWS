  ...
  return (
    <div style={(bg === "dark")?{background: "#20201b"}:{background: "#ffffff"}}>
      <BrowserRouter>
        ...
        <Routes>
          <Route exact path="/business" element={<NewsBase key="business" color={color} bg={bg} category={"business"}/>}/>
          ...
          <Route exact path="/technology" element={<NewsBase key="technology" color={color} bg={bg} category={"technology"}/>}/>
